...
@Component("newMarketService")
@Slf4j
public class NewMarketServiceImpl implements MarketService {
...
//		pfpHistoryPO.setTransactionId();
	...
	public R cancelList(Long tokenId) {
		try {
			...
			Market contract = Market.load(marketAddress, web3j, transactionManager, gasProvider);
...
//			log.info("售价{}，未中奖收益{},创作者收益{}",pfpTokenPO.getPrice(),loserReward,minterReward);
			...
			//钱包余额记录：收益：2-earn
			WallectHistoryPO wallectHistory0 = new WallectHistoryPO(pfpPickPO.getIndexUserId0(), 2, pfpTransactionPO.getId(), null, shareReward);
			WallectHistoryPO wallectHistory1 = new WallectHistoryPO(pfpPickPO.getIndexUserId1(), 2, pfpTransactionPO.getId(), null, shareReward);
			WallectHistoryPO wallectHistory2 = new WallectHistoryPO(pfpPickPO.getIndexUserId2(), 2, pfpTransactionPO.getId(), null, shareReward);
			WallectHistoryPO wallectHistory3 = new WallectHistoryPO(pfpPickPO.getIndexUserId3(), 2, pfpTransactionPO.getId(), null, shareReward);
